...
def show_stock_selector():
    ...
    with col1:
        ...
        # 筛选参数
        # 行业筛选 - 从 akshare 获取真实数据
        try:
            from industry import get_industry_list, get_stocks_by_industry
            real_industries = get_industry_list()
            industry_options = ["全部"] + real_industries
        except:
        ...
        if selected_industry != "全部":
            try:
                industry_stocks = get_stocks_by_industry(selected_industry)
            except:
                pass
        
        # 如果有真实行业数据，使用真实数据
        if industry_stocks:
            stock_pool = [(s['code'], s['name']) for s in industry_stocks]
        else:
            # 使用示例数据
            stock_pool = [
                ('600703', '三安光电'), ('002475', '长盈精密'), ('000063', '中兴通讯'),
                ('600519', '贵州茅台'), ('000858', '五粮液'), ('603288', '海天味业'),
                ('600036', '招商银行'), ('601398', '工商银行'), ('601318', '中国平安'),
                ...
                ('002410', '广联达'), ('002252', '上海莱士'), ('300760', '迈瑞医疗'),
                ('603259', '药明康德'), ('600085', '同仁堂'),
            ]
